...
<ul class="publication-list">
  ...
  <li>
    ...
    <div class="pub-authors">Fox, A.M., and Noh, H.</div>
  </li>

  <li>
    <div class="pub-title">Teacher Strikes and the Demobilization of Republican Voters</div>
    <div class="pub-authors">Lyon, M.A., Finger, L.K., and Noh, H.</div>
  </li>
</ul>
...
<ul class="publication-list">
  <li>
    ...
    <div class="pub-authors">Hwang, H., Han, S., Noh, H., Kim, I., Jang, M., and Kim, H.</div>
  ...
  <li>
    ...
    <div class="pub-authors">Choi, Y., Choi, J., Kim, J., Cho, W., Noh, H., and Han, S. </div>
